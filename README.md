...
Admins configure SFTP server host keys in publisher presets, with an explicit insecure accept-any option; see [SFTP host trust setup](./deploy/README.md#sftp-publisher-host-trust).
