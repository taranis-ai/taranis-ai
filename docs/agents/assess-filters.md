...
- The Assess pagination/editing browser workflow filters to its fixture source so scheduled collection from other sources cannot change its expected total.
