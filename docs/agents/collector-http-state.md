...
Browser-backed article fetches use the main navigation response's Last-Modified header as the news item's published-date fallback. Secondary browser responses do not update the primary resource's persisted HTTP validators.
