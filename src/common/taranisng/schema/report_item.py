...
from taranisng.schema.news_item import NewsItemAggregateSchema
from taranisng.schema.acl_entry import ACLEntryStatusSchema
from taranisng.schema.user import UserSchemaBase
...
class ReportItemAttributeBaseSchema(Schema):
    ...
    value = fields.Str()
    binary_mime_type = fields.Str(missing=None)
    binary_size = fields.Int(missing=0)
    binary_description = fields.Str(missing=None)
    attribute_group_item_title = fields.Str(missing=None)
    attribute_group_item_id = fields.Integer(missing=None)
...
class ReportItemBaseSchema(Schema):
    ...
    id = fields.Int(allow_none=True, missing=None)
    ...
    report_item_type_id = fields.Int(missing=None)
