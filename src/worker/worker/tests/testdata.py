...
story_1 = {
    ...
    "news_items": [
        NewsItem(
            ...
            collected=datetime.datetime(2023, 8, 1, 17, 1, 4, 802015),
            published=datetime.datetime(2023, 8, 1, 17, 1, 4, 801998),
            updated=datetime.datetime(2023, 8, 1, 17, 0, 39, 893435),
...
story_2 = {
    ...
    "news_items": [
        NewsItem(
            ...
            collected=datetime.datetime(2023, 8, 1, 17, 1, 4, 801951),
            published=datetime.datetime(2023, 8, 1, 17, 1, 4, 801934),
            updated=datetime.datetime(2023, 8, 1, 17, 0, 39, 893435),
            osint_source_id="78049551-dcef-45bd-a5cd-4fe842c4d5e2",
        )
    ],
...
story_3 = {
    ...
    "news_items": [
        NewsItem(
            ...
            collected=datetime.datetime(2023, 8, 1, 17, 1, 4, 801886),
            published=datetime.datetime(2023, 8, 1, 17, 1, 4, 801870),
            updated=datetime.datetime(2023, 8, 1, 17, 0, 39, 893435),
            osint_source_id="78049551-dcef-45bd-a5cd-4fe842c4d5e2",
        )
    ],
...
news_item_list = [story_1, story_2, story_3]
...
news_items = [
    NewsItem(
        ...
        published=datetime.datetime(2023, 10, 1, 18, 0, 0),
        author="tanmayapanda",
        collected=datetime.datetime(2023, 10, 2, 2, 3, 46, 763784),
        attributes=[],
    ),
    NewsItem(
        ...
        published=datetime.datetime(2023, 9, 30, 5, 0, 0),
        author="",
        collected=datetime.datetime(2023, 10, 1, 23, 56, 49, 738398),
    ...
    NewsItem(
        ...
        published=datetime.datetime(2023, 10, 2, 9, 9, 0),
        author="",
        collected=datetime.datetime(2023, 10, 2, 7, 28, 57, 881310),
    ...
    NewsItem(
        ...
        published=datetime.datetime(2023, 9, 29, 22, 3, 0),
        author="Günter Born",
        collected=datetime.datetime(2023, 10, 1, 23, 53, 31, 888330),
