...
class TestPublisherTaskFlowE2E:
    ...
    def test_publisher_flow_success(self, mock_core_api, mock_worker_modules, sample_publisher_request):
        ...
        # Arrange
        mock_core_api.get_product.return_value = {"id": "test_product_1", "title": "Test Product"}
        mock_core_api.get_publisher.return_value = {"id": "test_publisher_1", "type": "email_publisher"}
