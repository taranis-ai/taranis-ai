...
import worker.cron_config as cron_config
from worker.cron_config import TASK_FUNCTION_MAP, load_cron_jobs
...
class TestLoadCronJobs:
    ...
    def test_load_cron_jobs_registers_all_jobs(self, cron_core_api, sample_cron_jobs):
        """Test that load_cron_jobs registers all jobs from Core API"""
        cron_core_api.get_cron_jobs.return_value = sample_cron_jobs
        mock_scheduler = Mock()
    ...
    def test_load_cron_jobs_maps_task_names_to_functions(self, cron_core_api, sample_cron_jobs):
    ...
    def test_load_cron_jobs_skips_unknown_tasks(self, cron_core_api):
        """Test that unknown task names are skipped with a warning"""
        cron_core_api.get_cron_jobs.return_value = [
            {
                "task": "unknown_task",
                "queue": "test",
                "args": [],
    ...
    def test_load_cron_jobs_handles_empty_response(self, cron_core_api):
    ...
    def test_load_cron_jobs_handles_none_response(self, cron_core_api):
        """Test handling of None response from API"""
        cron_core_api.get_cron_jobs.return_value = None
        mock_scheduler = Mock()
    ...
    def test_load_cron_jobs_uses_global_register_without_scheduler(self, cron_core_api, sample_cron_jobs):
    ...
    def test_load_cron_jobs_converts_args_to_tuple(self, cron_core_api):
    ...
    def test_load_cron_jobs_raises_on_api_exception(self, cron_core_api):
        """Test that exceptions from Core API are raised"""
        cron_core_api.get_cron_jobs.side_effect = Exception("API Error")
        mock_scheduler = Mock()
    ...
    def test_load_cron_jobs_logs_registration_info(self, cron_core_api, sample_cron_jobs):
