...
class TestBotTaskFlowE2E:
    ...
    def test_bot_flow_success(self):
        ...
        with patch.object(bot_task_flow, "fn") as mock_flow_fn:
            mock_flow_fn.return_value = {"status": "success", "processed_items": 5}
    ...
    def test_bot_flow_with_filter(self):
        ...
        with patch.object(bot_task_flow, "fn") as mock_flow_fn:
            mock_flow_fn.return_value = {"status": "success", "processed_items": 3, "filter_applied": True}
    ...
    def test_bot_flow_bot_not_found(self):
        ...
        with patch.object(bot_task_flow, "fn") as mock_flow_fn:
            mock_flow_fn.return_value = {"status": "error", "error": "Bot with id 999 not found"}
    ...
    def test_bot_flow_invalid_bot_type(self):
        ...
        with patch.object(bot_task_flow, "fn") as mock_flow_fn:
            mock_flow_fn.return_value = {"status": "error", "error": "Bot type not implemented"}
