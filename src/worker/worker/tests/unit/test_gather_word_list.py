import pytest
from worker.flows.gather_word_list import gather_word_list_flow, get_word_list_info
...
class TestGatherWordListFlowE2E:
    ...
    def test_wordlist_flow_success(self, mock_core_api, mock_requests, sample_wordlist_request):
        ...
        # Arrange
        mock_core_api.get_word_list.return_value = {"id": 1, "name": "Test Wordlist", "link": "https://example.com/wordlist.txt"}
    ...
    def test_wordlist_flow_content_type_detection(self, mock_core_api, mock_requests, sample_wordlist_request):
        ...
        # Arrange
        mock_core_api.get_word_list.return_value = {"id": 1, "name": "Test Wordlist", "link": "https://example.com/wordlist.csv"}
