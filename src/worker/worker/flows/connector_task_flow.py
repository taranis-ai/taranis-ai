...
def connector_task_flow(request: ConnectorTaskRequest):
    try:
        logger.info("[connector_task_flow] Starting connector task - matches Celery behavior")
        ...
        if connector:
            ...
            if connector_config is not None:
                ...
                logger.info("[connector_task_flow] Connector task completed successfully")
                return result
            else:
        ...
        logger.exception("[connector_task_flow] Connector task failed")
        raise
