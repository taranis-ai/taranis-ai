...
def gather_word_list_flow(request: WordListTaskRequest):
    try:
        logger.info("[gather_word_list_flow] Starting word list gathering")
        # Get word list info
        ...
        logger.info("[gather_word_list_flow] Word list gathering completed successfully")

        return result

    except Exception:
        logger.exception("[gather_word_list_flow] Word list gathering failed")
        raise
