...
def setup_tasks():
    ...
    if "Presenters" in Config.WORKER_TYPES:
        try:
            ...
            # flows.append(presenter_task_flow.deploy(name="presenter_task_flow"))
            presenter_task_flow.serve(name="presenter_task_deployment", cron="* * * * *")
        except OSError as e:
    ...
    if "Bots" in Config.WORKER_TYPES:
        try:
            ...
            flows.append(bot_task_flow.serve(name="bot_task_deployment"))
    ...
    if "Collectors" in Config.WORKER_TYPES:
        try:
            ...
            flows.append(collector_task_flow.serve(name="collector_task_deployment"))
        except Exception as e:
    ...
    if "Publishers" in Config.WORKER_TYPES:
        try:
            ...
            flows.append(publisher_task_flow.serve(name="publisher_task_deployment"))
        except Exception as e:
    ...
    if "Connectors" in Config.WORKER_TYPES:
        try:
            ...
            flows.append(connector_task_flow.serve(name="connector_task_deployment"))
        except Exception as e:
