    ...
    def test_user_dashboard(self, non_admin_logged_in_page: Page, forward_console_and_page_errors_non_admin, stories_function_wrapper):
        ...
        def test_dashboard_entity_location_pagination(page: Page) -> None:
            def click_pagination(label: str) -> None:
                with_htmx_wait(page, lambda: page.locator("tfoot a", has_text=label).click())
            ...
            click_pagination("›")
            expect(page.locator("tfoot")).to_contain_text("Page 2 of 7")
            click_pagination("›")
            expect(page.locator("tfoot")).to_contain_text("Page 3 of 7")
            click_pagination("›")
            expect(page.locator("tfoot")).to_contain_text("Page 4 of 7")
            click_pagination("›")
            expect(page.locator("tfoot")).to_contain_text("Page 5 of 7")
            click_pagination("›")
            expect(page.locator("tfoot")).to_contain_text("Page 6 of 7")
            click_pagination("›")
