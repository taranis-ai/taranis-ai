...
from frontend.views.collaboration_views import CollaborationDocumentView, CollaborationStoryDialogView, CollaborationView
...
def init(app: Flask):
    ...
    bp.add_url_rule("/collaboration/add-story-dialog", view_func=CollaborationStoryDialogView.as_view("add_story_dialog"))
