...
class ProductTypeParameterAPI(MethodView):
    ...
    def get(self):
        ...
        return ProductTypeView.get_product_type_parameters_view(presenter_type)
...
def init(app: Flask):
    ...
    admin_bp.add_url_rule("/product_type_parameters", view_func=ProductTypeParameterAPI.as_view("product_type_parameters"))
