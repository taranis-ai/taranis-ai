<template>
  <div class="d-flex">
    <v-btn-group class="flex-grow-1" density="compact" divided>
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = 'shift'" data-testid="from-end-last-shift-button">
        <v-tooltip
          activator="parent"
          location="top"
      ...
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = 'week'" data-testid="from-last-monday-button">
        <v-tooltip activator="parent" location="top" text="from last monday" />
        <v-icon icon="mdi-calendar-week" />
      </v-btn>
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = '24h'" data-testid="last-24h-button">
