<template>
  <div class="d-flex">
    <v-btn-group class="flex-grow-1" density="compact" divided>
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = 'shift'">
        <v-tooltip
          activator="parent"
          location="top"
      ...
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = 'week'">
        <v-tooltip activator="parent" location="top" text="from last monday" />
        <v-icon icon="mdi-calendar-week" />
      </v-btn>
      <v-btn class="flex-grow-1" variant="outlined" @click="selected = '24h'">
