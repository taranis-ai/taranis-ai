...
export default {
  ...
  methods: {
    ...mapActions('config', ['loadOrganizations', 'loadRoles', 'loadPermissions', 'loadUsers']),
    ...mapGetters('config', ['getUsers', 'getOrganizations', 'getRoles', 'getPermissions', 'getUserByID']),
    add() {
      this.$validator.validateAll().then(() => {
        ...
        this.user.organizations = this.selected_organizations.map(org => ({ id: org.id }))
        this.user.permissions = this.selected_permissions.map(perm => ({ id: perm.id }))
        this.user.roles = this.selected_roles.map(role => ({ id: role.id }))
