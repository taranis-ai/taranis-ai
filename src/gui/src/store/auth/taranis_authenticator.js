...
const getters = {
  ...
  hasExternalLogoutUrl () {
    if (typeof (process.env) === 'undefined') { return (('$VUE_APP_TARANIS_NG_LOGOUT_URL' !== '') && ('$VUE_APP_TARANIS_NG_LOGOUT_URL'[0] != '$')) }
  ...
  getLogoutURL () {
    if (typeof (process.env) === 'undefined') {
      if (('$VUE_APP_TARANIS_NG_LOGOUT_URL' !== '') && ('$VUE_APP_TARANIS_NG_LOGOUT_URL'[0] != '$')) { return '$VUE_APP_TARANIS_NG_LOGOUT_URL' }
    } else {
      if (process.env.VUE_APP_TARANIS_NG_LOGOUT_URL != null) { return process.env.VUE_APP_TARANIS_NG_LOGOUT_URL }
    }
    return '/logout'
  },
