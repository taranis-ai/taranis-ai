export const messages_de = {
  ...
  word_list: {
    ...
    description: 'Beschreibung',
    link: 'URL',
    collector_includelist: 'Includelist während der Sammlung',
    collector_excludelist: 'Exclude während der Sammlung',
