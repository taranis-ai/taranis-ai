...
class TaskHistoryStats(TaranisBaseModel):
    ...
    last_run_display: str | None = ...
    last_success_display: str | None = ...
    successes: int = ...
    failures: int = ...
    total: int = ...
    success_pct: int = ...
    status_badge: dict[str, str] | None = ...
...
class TaskHistoryResponse(TaranisBaseModel):
    ...
    items: list[Task] = ...
    total_count: int = ...
    task_stats: dict[str, TaskHistoryStats] = ...
...
class CuratedOSINTSourceCatalog(TaranisBaseModel):
    ...
    def validate_catalog_references(self) -> CuratedOSINTSourceCatalog: ...
