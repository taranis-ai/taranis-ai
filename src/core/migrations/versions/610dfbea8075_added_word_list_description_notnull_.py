...
def upgrade():
    ...
    op.alter_column(
        "word_list", "description", existing_type=sa.VARCHAR(), nullable=False
    )

    op.alter_column(
        "word_list_category", "description", existing_type=sa.VARCHAR(), nullable=False
    )

    op.alter_column(
        "word_list_entry", "description", existing_type=sa.VARCHAR(), nullable=False
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column(
        "word_list", "description", existing_type=sa.VARCHAR(), nullable=True
    )
    # ### end Alembic commands ###
