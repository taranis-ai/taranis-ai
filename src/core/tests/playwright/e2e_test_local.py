...
def test_run(playwright: Playwright) -> None:
    ...
    click_with_highlight(page.locator("div:nth-child(2) > div:nth-child(2) > a").first)
    ...
    click_with_highlight(page.get_by_role("button", name="Report"))
    click_with_highlight(page.get_by_label("Open"))
