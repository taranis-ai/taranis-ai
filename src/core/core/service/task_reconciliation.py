...
class TaskReconciliationService:
    ...
    def _persist_failure(
        ...
        *,
        ...
        existing_result = json.loads(existing.result) if existing and existing.result else None
        existing_reason = existing_result.get("reason") if isinstance(existing_result, dict) else None
