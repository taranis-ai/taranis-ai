workers = [
    ...
    },
    {
        ...
        "parameters": [
            ...
            {"parameter": "PROXY_SERVER"},
            {"parameter": "REFRESH_INTERVAL"},
            {"parameter": "AUTH_USERNAME"},
            {"parameter": "AUTH_PASSWORD"},
            {"parameter": "CLIENT_CERT_DIR"},
            {"parameter": "POPUP_CLOSE_SELECTOR"},
            {"parameter": "TITLE_SELECTOR"},
            {"parameter": "NEXT_BUTTON_SELECTOR"},
            {"parameter": "LOAD_MORE_BUTTON_SELECTOR"},
            {"parameter": "PAGINATION_LIMIT"},
            {"parameter": "ARTICLE_DESCRIPTION_SELECTOR"},
            {"parameter": "ARTICLE_FULL_TEXT_SELECTOR"},
            {"parameter": "SINGLE_ARTICLE_LINK_SELECTOR"},
            {"parameter": "AUTHOR_SELECTOR"},
            {"parameter": "PUBLISHED_SELECTOR"},
            {"parameter": "ATTACHMENT_SELECTOR"},
            {"parameter": "WORD_LIMIT"},
            {"parameter": "ADDITIONAL_ID_SELECTOR"},
        ],
