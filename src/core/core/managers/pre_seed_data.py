...
permissions = [
    ...
    {"id": "CONFIG_ACCESS", "name": "Configuration access", "description": "Access to Configuration module"},
    {"id": "CONFIG_ORGANIZATION_ACCESS", "name": "Config organizations access", "description": "Access to attributes configuration"},
    {"id": "CONFIG_ORGANIZATION_CREATE", "name": "Config organization create", "description": "Create organization configuration"},
    {"id": "CONFIG_ORGANIZATION_UPDATE", "name": "Config organization update", "description": "Update organization configuration"},
    {"id": "CONFIG_ORGANIZATION_DELETE", "name": "Config organization delete", "description": "Delete organization configuration"},
    {"id": "CONFIG_USER_ACCESS", "name": "Config users access", "description": "Access to users configuration"},
    {"id": "CONFIG_USER_CREATE", "name": "Config user create", "description": "Create user configuration"},
    {"id": "CONFIG_USER_UPDATE", "name": "Config user update", "description": "Update user configuration"},
    {"id": "CONFIG_USER_DELETE", "name": "Config user delete", "description": "Delete user configuration"},
    {"id": "CONFIG_ROLE_ACCESS", "name": "Config roles access", "description": "Access to roles configuration"},
    {"id": "CONFIG_ROLE_CREATE", "name": "Config role create", "description": "Create role configuration"},
    {"id": "CONFIG_ROLE_UPDATE", "name": "Config role update", "description": "Update role configuration"},
    {"id": "CONFIG_ROLE_DELETE", "name": "Config role delete", "description": "Delete role configuration"},
    {"id": "CONFIG_ACL_ACCESS", "name": "Config acls access", "description": "Access to acls configuration"},
    {"id": "CONFIG_ACL_CREATE", "name": "Config acl create", "description": "Create acl configuration"},
    {"id": "CONFIG_ACL_UPDATE", "name": "Config acl update", "description": "Update acl configuration"},
    {"id": "CONFIG_ACL_DELETE", "name": "Config acl delete", "description": "Delete acl configuration"},
    {"id": "CONFIG_PRODUCT_TYPE_ACCESS", "name": "Config product types access", "description": "Access to product types configuration"},
    {"id": "CONFIG_PRODUCT_TYPE_CREATE", "name": "Config product type create", "description": "Create product type configuration"},
    {"id": "CONFIG_PRODUCT_TYPE_UPDATE", "name": "Config product type update", "description": "Update product type configuration"},
    {"id": "CONFIG_PRODUCT_TYPE_DELETE", "name": "Config product type delete", "description": "Delete product type configuration"},
    {"id": "CONFIG_ATTRIBUTE_ACCESS", "name": "Config attributes access", "description": "Access to attributes configuration"},
    {"id": "CONFIG_ATTRIBUTE_CREATE", "name": "Config attribute create", "description": "Create attribute configuration"},
    {"id": "CONFIG_ATTRIBUTE_UPDATE", "name": "Config attribute update", "description": "Update attribute configuration"},
    {"id": "CONFIG_ATTRIBUTE_DELETE", "name": "Config attribute delete", "description": "Delete attribute configuration"},
    {
        "id": "CONFIG_REPORT_TYPE_ACCESS",
        "name": "Config report item types access",
        "description": "Access to report item types configuration",
    },
    {"id": "CONFIG_REPORT_TYPE_CREATE", "name": "Config report item type create", "description": "Create report item type configuration"},
    {"id": "CONFIG_REPORT_TYPE_UPDATE", "name": "Config report item type update", "description": "Update report item type configuration"},
    {"id": "CONFIG_REPORT_TYPE_DELETE", "name": "Config report item type delete", "description": "Delete report item type configuration"},
    {"id": "CONFIG_WORD_LIST_ACCESS", "name": "Config word lists access", "description": "Access to word lists configuration"},
    {"id": "CONFIG_WORD_LIST_CREATE", "name": "Config word list create", "description": "Create word list configuration"},
    {"id": "CONFIG_WORD_LIST_UPDATE", "name": "Config word list update", "description": "Update word list configuration"},
    {"id": "CONFIG_WORD_LIST_DELETE", "name": "Config word list delete", "description": "Delete word list configuration"},
    {"id": "CONFIG_OSINT_SOURCE_ACCESS", "name": "Config OSINT source access", "description": "Access to OSINT sources configuration"},
    {"id": "CONFIG_OSINT_SOURCE_CREATE", "name": "Config OSINT source create", "description": "Create OSINT source configuration"},
    {"id": "CONFIG_OSINT_SOURCE_UPDATE", "name": "Config OSINT source update", "description": "Update OSINT source configuration"},
    {"id": "CONFIG_OSINT_SOURCE_DELETE", "name": "Config OSINT source delete", "description": "Delete OSINT source configuration"},
    {
        "id": "CONFIG_OSINT_SOURCE_GROUP_ACCESS",
        "name": "Config OSINT source group access",
        "description": "Access to OSINT sources groups configuration",
    },
    {
        "id": "CONFIG_OSINT_SOURCE_GROUP_CREATE",
        "name": "Config OSINT source group create",
        "description": "Create OSINT source group configuration",
    },
    {
        "id": "CONFIG_OSINT_SOURCE_GROUP_UPDATE",
        "name": "Config OSINT source group update",
        "description": "Update OSINT source group configuration",
    },
    {
        "id": "CONFIG_OSINT_SOURCE_GROUP_DELETE",
        "name": "Config OSINT source group delete",
        "description": "Delete OSINT source group configuration",
    },
    ...
    {"id": "CONFIG_PUBLISHER_ACCESS", "name": "Config publisher presets access", "description": "Access to publisher presets configuration"},
    {"id": "CONFIG_PUBLISHER_CREATE", "name": "Config publisher preset create", "description": "Create publisher preset configuration"},
    {"id": "CONFIG_PUBLISHER_UPDATE", "name": "Config publisher preset update", "description": "Update publisher preset configuration"},
    {"id": "CONFIG_PUBLISHER_DELETE", "name": "Config publisher preset delete", "description": "Delete publisher preset configuration"},
