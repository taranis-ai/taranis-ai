...
class StoryConflicts(MethodView):
    ...
    def put(self, story_id):
        ...
        invalidate_frontend_cache_on_success(
            code, models=("story", "news_item", "report_item", "filter_lists"), object_ids={"story": story_id}
        )
...
class NewsItemConflicts(MethodView):
    ...
    def post(self):
        ...
        invalidate_frontend_cache_on_success(code, models=("story", "news_item", "report_item", "filter_lists"))
        return result, 200
