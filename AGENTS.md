...
- NEVER add agent co-authoring information (e.g., "Generated by Mistral Vibe" or "Co-Authored-By") to git commit messages. This project does not accept automated co-authoring attribution.
